...
(** Simple entrypoint that uses [typeclass_instances].
    A more idiomatic usage is to invoke [ltac2.goal_dispatch_with] for example
    [[
    ltac1:(ltac2.goal_dispatch_with [ident:(my_hint_db)])
    ]]
    See crush_ext.v for an example.
 *)
Ltac goal_dispatch :=
  idtac;
