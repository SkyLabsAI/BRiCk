...
(** NOTE FOR MAINTAINTERS: This is the central authority for controlling the
  ...
  (The instances for [own] are picked by `skylabs.iris.extra.base_logic.own_instances`.)
...
Require Export skylabs.iris.extra.bi.na_invariants.
Require Export skylabs.iris.extra.bi.cancelable_invariants.

(* [own] instances for iProp or monPred *)
Require Export skylabs.iris.extra.base_logic.own_instances.

(* [inv] and [cinv] instances for iProp. Currently not exported. *)
(* Require Export skylabs.iris.extra.base_logic.iprop_invariants. *)
...
Require Export skylabs.iris.extra.bi.weakly_objective.
Require Export skylabs.iris.extra.base_logic.monpred_invariants.
