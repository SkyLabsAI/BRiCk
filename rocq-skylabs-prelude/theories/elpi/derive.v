...
(* WARNING: importing [elpi.apps.derive] has the side effect of setting
   ...
   instead use [skylabs.prelude.elpi.derive.common]. *)

Require Export skylabs.prelude.elpi.derive.eq_dec.
(*Test Uniform Inductive Parameters.*)
Require Export skylabs.prelude.elpi.derive.inhabited.
(*Test Uniform Inductive Parameters.*)
Require Export skylabs.prelude.elpi.derive.finite.
(*Test Uniform Inductive Parameters.*)
Require Export skylabs.prelude.elpi.derive.countable.
(*Test Uniform Inductive Parameters.*)
Require Export skylabs.prelude.elpi.derive.finite_type.
(*Test Uniform Inductive Parameters.*)
Require Export skylabs.prelude.elpi.derive.bitset.
(*Test Uniform Inductive Parameters.*)
Require Export skylabs.prelude.elpi.derive.lens.
(*Test Uniform Inductive Parameters.*)
