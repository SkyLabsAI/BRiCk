  ...
  $ grep -q 'Esizeof_pack None "T"' test_17_cpp_templates.v
  $ grep -q 'Esizeof_pack None "args"' test_17_cpp_templates.v
  $ grep -q '(Some 3%N) "T"' test_17_cpp.v
  $ grep -q '(Some 3%N) "args"' test_17_cpp.v
