...
whose dependent bound is deduced from its initializer, and defer overload
resolution for a direct allocation-function call. All four cases retain exact
final-core boundaries and compile in ordinary and companion output.
...
erased lambda name keeps both synthesized and transformed provenance.
